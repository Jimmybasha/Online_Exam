...
class GetAllQuestionsOnExamViewModelCubit
    extends Cubit<GetAllQuestionsOnExamViewModelState> {
  GetAllQuestionsOnExamUseCase getAllQuestionsOnExamUseCase;

  GetAllQuestionsOnExamViewModelCubit(this.getAllQuestionsOnExamUseCase)
