...
class _ProfilePageBodyState extends State<ProfilePageBody> {
  ...
  initState() {
    ...
    _usernameController = TextEditingController(
        text: widget.user?.user?.username ?? "userName isn't available");
    _firstNameController = TextEditingController(
        text: widget.user?.user?.firstName ?? "firstName isn't available");
    _lastNameController = TextEditingController(
        text: widget.user?.user?.lastName ?? "lastName isn't available ");
    _emailController = TextEditingController(
        text: widget.user?.user?.email ?? "Email isn't available");
    _passwordController = TextEditingController();
    _phoneNumberController = TextEditingController(
        text: widget.user?.user?.phone ?? "Phone isn't available");
  }
